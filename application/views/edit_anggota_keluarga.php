		...
		<form class="" action="insert" method="post" ">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="form-group">
						<select class="form-control" name="suku_bangsa">
							...
							if($value->suku_bangsa == $data->suku_bangsa)
								{
									$selected = "selected";
								}else{
									$selected = "";
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						<input class="form-control" type="" name="tempat_dan_tgl_baptis" placeholder="Tempat Dan Tanggal Baptis" value="<?php echo $data->tempat_dan_tgl_baptis; ?>">
					</div>
					<div class="form-group">
						<input class="form-control" type="" name="tempat_dan_tahun_penguatan" placeholder="Tempat Dan Tahun Penguatan" value="<?php echo $data->tempat_dan_tahun_penguatan; ?>">
					</div>
					<div class="form-group">
					...
					<input type="hidden" name="media" value="edit">
